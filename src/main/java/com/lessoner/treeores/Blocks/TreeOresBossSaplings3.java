...
import com.lessoner.treeores.WorldGen.WorldGenTreeOresBoss3;
 ...
 */
public class TreeOresBossSaplings3 extends BlockSapling {
    private static final IIcon[] I_ICONS = new IIcon[TreeOresLogs3.types.length];
    ...
    public IIcon getIcon(int side, int meta) {
        meta &= 7;
        return I_ICONS[MathHelper.clamp_int(meta, 0, 2)];
    }
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOresBoss3(TreeOresBlocks.TreeOresLogs3, TreeOresBlocks.TreeOresBossLeaves3, 0, 0, false, 15, 7, false);

                break;
            case 1:
                object = new WorldGenTreeOresBoss3(TreeOresBlocks.TreeOresLogs3, TreeOresBlocks.TreeOresBossLeaves3, 1, 1, false, 15, 7, false);

                break;
            case 2:
                object = new WorldGenTreeOresBoss3(TreeOresBlocks.TreeOresLogs3, TreeOresBlocks.TreeOresBossLeaves3, 2, 2, false, 15, 7, false);

                break;
            case 3:
               /* if (References.obsidianTree) {
                    object = new WorldGenTreeOres2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresLeaves2, 3, 3, false, 4, 8, false);
                }
                break;*/
            case 4:
               /* if (TreeOres.diamondtree) {
                    object = new WorldGenDiamondTree(TreeOresBlocks.TreeOresLogs12, TreeOresBlocks.TreeOresLeaves12, 0, 0, false, 4, 8, false);
                }*/
                break;
            case 5:
              /*  if (TreeOres.emeraldtree) {
                    object = new WorldGenEmeraldTree(TreeOresBlocks.TreeOresLogs12, TreeOresBlocks.TreeOresLeaves12, 1, 1, false, 4, 8, false);
                }*/
                break;
            case 6:
                break;
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        for (int i = 0; i < I_ICONS.length; ++i) {
            I_ICONS[i] = iconRegister.registerIcon(References.MODID + ":" + this.getTextureName() + "_" + TreeOresLogs3.types[i]);
        }
    }
