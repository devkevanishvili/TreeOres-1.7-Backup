...
import com.lessoner.treeores.WorldGen.WorldGenTreeOresBoss2;
 ...
 */
public class TreeOresBossSaplings2 extends BlockSapling {
    private static final IIcon[] I_ICONS = new IIcon[TreeOresLogs2.types.length];
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOresBoss2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresBossLeaves2, 0, 0, false, 15, 7, false);

                break;
            case 1:
                object = new WorldGenTreeOresBoss2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresBossLeaves2, 1, 1, false, 15, 7, false);

                break;
            case 2:
                object = new WorldGenTreeOresBoss2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresBossLeaves2, 2, 2, false, 15, 7, false);

                break;
            case 3:
                object = new WorldGenTreeOresBoss2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresBossLeaves2, 3, 3, false, 15, 7, false);
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        for (int i = 0; i < I_ICONS.length; ++i) {
            I_ICONS[i] = iconRegister.registerIcon(References.MODID + ":" + this.getTextureName() + "_" + TreeOresLogs2.types[i]);
        }
    }
