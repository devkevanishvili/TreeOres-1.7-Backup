...
import com.lessoner.treeores.WorldGen.WorldGenTreeOresBoss1;
 ...
 */
public class TreeOresBossSaplings1 extends BlockSapling {
    private static final IIcon[] I_ICONS = new IIcon[TreeOresLogs1.types.length];
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOresBoss1(TreeOresBlocks.TreeOresLogs1, TreeOresBlocks.TreeOresBossLeaves1, 0, 0, false, 15, 7, false);

                break;
            case 1:
                object = new WorldGenTreeOresBoss1(TreeOresBlocks.TreeOresLogs1, TreeOresBlocks.TreeOresBossLeaves1, 1, 1, false, 15, 7, false);

                break;
            case 2:
                object = new WorldGenTreeOresBoss1(TreeOresBlocks.TreeOresLogs1, TreeOresBlocks.TreeOresBossLeaves1, 2, 2, false, 15, 7, false);

                break;
            case 3:
                object = new WorldGenTreeOresBoss1(TreeOresBlocks.TreeOresLogs1, TreeOresBlocks.TreeOresBossLeaves1, 3, 3, false, 15, 7, false);
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        for (int i = 0; i < I_ICONS.length; i++) {
            I_ICONS[i] = iconRegister.registerIcon(References.MODID + ":" + this.getTextureName() + "_" + TreeOresLogs1.types[i]);
        }
    }
