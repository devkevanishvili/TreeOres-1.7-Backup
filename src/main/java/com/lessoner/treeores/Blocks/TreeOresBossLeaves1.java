 ...
 */
public class TreeOresBossLeaves1 extends BlockOldLeaf {
    public static final String[][] leaf_types = new String[][]{{"tleaves_iron", "tleaves_gold", "tleaves_coal", "tleaves_redstone"}, {"tleaves_iron_opaque", "tleaves_gold_opaque", "tleaves_coal_opaque", "tleaves_redstone_opaque"}};
    ...
    public int getRenderColor(int meta) {
        return (meta & 3) == 0 ? LeafColors.iron() : ((meta & 3) == 1 ? LeafColors.gold() : ((meta & 3) == 2 ? LeafColors.coal() : ((meta & 3) == 3 ? LeafColors.redstone() : super.getRenderColor(meta))));
    }
    ...
    public int colorMultiplier(IBlockAccess iBlockAccess, int x, int y, int z) {
        ...
        return (meta & 3) == 0 ? LeafColors.iron() : ((meta & 3) == 1 ? LeafColors.gold() : ((meta & 3) == 2 ? LeafColors.coal() : ((meta & 3) == 3 ? LeafColors.redstone() : super.colorMultiplier(iBlockAccess, x, y, z))));
    }

    protected void func_150124_c(World world, int x, int y, int z, int meta, int i) {
        if (((meta & 3) == 0) && (world.rand.nextInt(i) == 0)) {
            this.dropBlockAsItem(world, x, y, z, new ItemStack(Items.iron_ingot, 1, 0));
        }
        if (((meta & 3) == 1) && (world.rand.nextInt(i) == 0)) {
            this.dropBlockAsItem(world, x, y, z, new ItemStack(Items.gold_ingot, 1, 0));
        }
        if (((meta & 3) == 2) && (world.rand.nextInt(i) == 0)) {
            this.dropBlockAsItem(world, x, y, z, new ItemStack(Items.coal, 1, 0));
        }
        if (((meta & 3) == 3) && (world.rand.nextInt(i) == 0)) {
            this.dropBlockAsItem(world, x, y, z, new ItemStack(Items.redstone, 1, 0));
        }
    }
