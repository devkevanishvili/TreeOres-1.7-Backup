 ...
 */
public class TreeOresNormalApples3 extends ItemAppleGold {
    @SideOnly(Side.CLIENT)
    private IIcon[] iicon;

    public TreeOresNormalApples3(int healAmount, float saturation, boolean wolf) {
    ...
    protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
        if (!world.isRemote) {
            ...
            switch (itemStack.getItemDamage()) {
                case 0:
                    //glowstone
                    entityPlayer.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 5000, 0));
                    break;
                case 1:
                    //quartz
                    entityPlayer.addPotionEffect(new PotionEffect(Potion.jump.id, 5000, 0));
                    break;
                case 2:
                    //xp
                    entityPlayer.addPotionEffect(new PotionEffect(Potion.heal.id, 5000, 2));
                    break;
            }
        } else {
