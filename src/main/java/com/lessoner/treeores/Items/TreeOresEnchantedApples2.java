 ...
 */
public class TreeOresEnchantedApples2 extends ItemAppleGold {
    @SideOnly(Side.CLIENT)
    private IIcon[] iicon;

    public TreeOresEnchantedApples2(int healAmount, float saturation, boolean wolf) {
    ...
    protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
        if (!world.isRemote) {
            ...
            switch (itemStack.getItemDamage()) {
                case 0:
                    //diamond
                    entityPlayer.addPotionEffect(new PotionEffect(Potion.damageBoost.id, 10000, 3));
                    break;
                case 1:
                    //emerald
                    entityPlayer.addPotionEffect(new PotionEffect(Potion.heal.id, 10000, 3));
                    break;
                case 2:
                    //lapis
                    entityPlayer.addPotionEffect(new PotionEffect(Potion.invisibility.id, 10000, 3));
                    break;
                case 3:
                    //obsidian
                    entityPlayer.addPotionEffect(new PotionEffect(Potion.fireResistance.id, 10000, 3));
